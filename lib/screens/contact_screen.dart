...
class _ContactScreenState extends State<ContactScreen> {
                        ...
                        children: [
                          Expanded(
                            ...
                            child: AnimatedSection(
                              ...
                              child: _buildContactForm(context, isDesktop, isTablet),
                            ),
                          ),
  ...
  Widget _buildContactForm(BuildContext context, bool isDesktop, bool isTablet) {
    return Container(
      padding: EdgeInsets.all(
        isDesktop
            ? 32
  ...
  Widget _buildContactInfo(BuildContext context, personalInfo) {
    final contactItems = [
      {'icon': Icons.email_rounded, 'label': 'Email', 'value': personalInfo.email, 'color': Colors.red},
      {'icon': Icons.location_on_rounded, 'label': 'Location', 'value': personalInfo.location, 'color': Colors.blue},
    ];
  ...
  Widget _buildSocialLinks(BuildContext context, bool isDesktop, bool isTablet) {
    final socialLinks = [
      {'name': 'LinkedIn', 'icon': 'assets/icons/linkedin.png', 'url': 'https://www.linkedin.com/in/amarjit-mallick/'},
      {'name': 'GitHub', 'icon': 'assets/icons/github.png', 'url': 'https://github.com/amarjitmallick'},
      {'name': 'Twitter', 'icon': 'assets/icons/twitter.png', 'url': 'https://x.com/amarjitmallick_'},
    ];
          ...
          Wrap(
            ...
            children: socialLinks.map((link) {
              return ActionChip(
                ...
                avatar: Image.asset(link['icon'] as String, width: 18, height: 18, fit: BoxFit.contain),
